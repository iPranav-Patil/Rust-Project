...
const Login = () => {
  ...
  return (
    <>
      {toast && toasttype && (
        <>
          <Toast message={"Successfully Logged In"} type={true} />
        </>
      )}
      {toast && !toasttype && (
        <>
          <Toast message={"User Not Found"} type={false} />
        </>
      )}
          ...
          <div className="relative z-10 w-full max-w-md">
            ...
            <div className=" mt-6 space-y-3">
              ...
              <p className="text-gray-300">
                This is platform is really good, try it once!
              </p>
            ...
            <div className="">
              ...
              <div className="mt-5 space-y-2">
                ...
                <div className=" flex gap-2">
                  Not a user yet? Get started Here{" "}
                  <div
                    onClick={() => {
                      navigate("/signup");
                    }}
